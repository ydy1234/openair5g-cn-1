...
Tai AmfEventArea::getTrackingAreas() const
{
    return m_TrackingAreas;
}
void AmfEventArea::setTrackingAreas(Tai const& value)
{
...
std::vector<Ecgi>& AmfEventArea::getEcgi()
{
    return m_Ecgi;
}
...
std::vector<Ncgi>& AmfEventArea::getNcgi()
{
    return m_Ncgi;
}
