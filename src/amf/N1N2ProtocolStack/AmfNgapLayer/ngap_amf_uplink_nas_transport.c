...
Ngap_UplinkNASTransport_IEs_t *make_NAS_PDU(UPLINK_NAS_TRANSPORT_WITH_NAS_MSG_TYPE_t nasMsgType)
{
	...
	switch(nasMsgType)
	{
	   case UPLINK_NAS_TRANSPORT_WITH_AUTHENTICATION_RESPONSE:
	   {
	       uplink_nas_transport_with_auth_response(data);
	   }
	   break;
	   case UPLINK_NAS_TRANSPORT_WITH_SECUTIRY_MODE_COMPLETE:
	   {
	   	   uplink_nas_transport_with_security_mode_complete(data);
	   }
	   break;
       case UPLINK_NAS_TRANSPORT_WITH_SECUTIRY_MODE_REJECT:
	   {
	   	   uplink_nas_transport_with_security_mode_reject(data);
	   }
	   break;
	   default:
...
Ngap_NGAP_PDU_t *make_NGAP_UplinkNasTransport(UPLINK_NAS_TRANSPORT_WITH_NAS_MSG_TYPE_t nasMsgType)
{
