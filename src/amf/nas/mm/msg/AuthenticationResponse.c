...
int
decode_authentication_response ( authentication_response_msg * authentication_response,
  uint8_t * buffer,
  uint32_t len)
{
  int                                     decoded = 0;
...
int
encode_authentication_response ( authentication_response_msg * authentication_response,
  uint8_t * buffer,
  uint32_t len)
{
  int                                     encoded = 0;
