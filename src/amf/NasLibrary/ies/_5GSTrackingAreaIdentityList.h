...
#define LIST_OF_TACS_BELONGING_TO_ONE_PLMN_WITH_NON_CONSECUTIVE_TAC_VALUES 0x0
#define LIST_OF_TACS_BELONGING_TO_ONE_PLMN_WITH_CONSECUTIVE_TAC_VALUES 0x1
#define LIST_OF_TAIS_BELONGING_TO_DIFFERENT_PLMNS 0x2
