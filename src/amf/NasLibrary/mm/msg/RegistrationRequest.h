...
#define REGISTRATION_REQUEST_PAYLOAD_CONTAINER_IEI 0x80
#define REGISTRATION_REQUEST_PAYLOAD_CONTAINER_TYPE_IEI 0x7B
...
#define REGISTRATION_REQUEST_PAYLOAD_CONTAINER_TYPE_PRESENT (1<<18)
